...
module "vpc-host-dev" {
    ...
    project_id   = module.vpc-host-dev-gc389-sd582.project_id
...
resource "google_compute_firewall" "vpc-host-dev-allow-iap-rdp" {
  ...
  project   = module.vpc-host-dev-gc389-sd582.project_id
  direction = "INGRESS"
  priority  = 10000
...
module "vpc-host-nonprod" {
    ...
    project_id   = module.vpc-host-nonprod-gc389-sd582.project_id
...
resource "google_compute_firewall" "vpc-host-nonprod-allow-iap-rdp" {
  ...
  project   = module.vpc-host-nonprod-gc389-sd582.project_id
  direction = "INGRESS"
  priority  = 10000
...
module "vpc-host-prod" {
    ...
    project_id   = module.vpc-host-prod-gc389-sd582.project_id
...
resource "google_compute_firewall" "vpc-host-prod-allow-iap-ssh" {
  ...
  project   = module.vpc-host-prod-gc389-sd582.project_id
  direction = "INGRESS"
  priority  = 10000
